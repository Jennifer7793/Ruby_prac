...
def random_shoupai
  ...
  pai_1 = pai.sample(13).sort
  p pai_1
  pai_2 = pai.difference(pai_1).sample(13).sort
  p pai_2
  pai_3 = pai.difference(pai_1+pai_2).sample(13).sort
  p pai_3
  pai_4 = pai.difference(pai_1+pai_2+pai_3).sample(13).sort
  p pai_4

  all_shoupai = pai_1+pai_2+pai_3+pai_4
  leftover = pai.difference(all_shoupai)
  p leftover
  leftover = leftover.shuffle
  p leftover
  until leftover.length == 14
    get_pai = leftover.shift
    p get_pai
  end
  p leftover
end
